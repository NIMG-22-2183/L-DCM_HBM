function DCM = spm_dcm_csd_AJAJ(DCM)
...
%--------------------------------------------------------------------------
[pE,pC]  = spm_dcm_neural_priors_AJAJ(DCM.A,DCM.B,DCM.C,model);
...
[pE,pC] = spm_L_priors_AJAJ(DCM.M.dipfit,pE,pC);
...
%--------------------------------------------------------------------------
[x,f]    = spm_dcm_x_neural_AJAJ(pE,model);
...
% create DCM
%--------------------------------------------------------------------------
DCM.M.IS = 'spm_csd_mtf_AJAJ';
DCM.M.g  = 'spm_gx_erp_AJAJ';
DCM.M.f  = f;
DCM.M.x  = x;
...
%--------------------------------------------------------------------------
try
    DCM.M.U = spm_dcm_eeg_channelmodes_AJAJ(DCM.M.dipfit,Nm);
end
