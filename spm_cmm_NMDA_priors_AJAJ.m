function [pE,pC] = spm_cmm_NMDA_priors_AJAJ(A,B,C)
...
%--------------------------------------------------------------------------
pE.S      = 0;             pC.S    = 1/64;
% pE.MG     =zeros(n,1);              pC.MG = ones(n,1)/16;
...
% This section changes NMDA/AMPA and Inhibitory as different variables
...
pE.Hampa  = repmat(zeros(p,p),[1 1 n]);
pC.Hampa  = repmat(EE        ,[1 1 n]);
...
I   = [  1    0    1   0
         ...
         0    0    1   0
         0    0    1   1]/32;
pE.Hi  = repmat(zeros(p,p),[1 1 n]);
pC.Hi  = repmat(I       ,[1 1 n]);
